...
import logoinstagram from '../../asset/img/ic-instagram@2x.png'
...
import assetsatu from '../../asset/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg'
import assetdua from '../../asset/img/logo-ALTA-v2.png'
function About(){
                ...
                <div className="container">
                  <div className="row pt-5 pb-5">
                    <div className="pl-5 col-lg-5 col-md-4 col-sm-12 col-12 text-lg-left text-md-left text-sm-center">
                      <a href="index.html"><img className="logo-bawah" src={assetdua} /></a>
                    </div>
                    <div className="col-lg-3 col-md-3 col-sm-12 col-12 text-lr-left text-md-center text-sm-center">
                      ...
                      {/* </div> */}
                      {/* <div class="col-3 text-center"> */}
                      <a href="https://www.instagram.com/alterra.academy/"><img className="logo-sosmed" src={logoinstagram} /></a>
                      {/* </div> */}
                      {/* <div class="col-3 text-center"> */}
